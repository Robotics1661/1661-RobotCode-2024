...
public class TunerConstants {
    ...
    // TODO_COMP: This needs to be done on the actual carpet
    private static final double kSlipCurrentA = 300.0;

    // Theoretical free speed (m/s) at 12v applied output;
    // This needs to be tuned to your individual robot
    public static final double kSpeedAt12VoltsMps = 3.92; // TODO how to tune this?
    ...
    private static final SwerveModuleConstantsFactory ConstantCreator = new SwerveModuleConstantsFactory()
            ...
            .withFeedbackSource(SteerFeedbackType.RemoteCANcoder) // use FusedCANcoder if we purchase pro
    ...
    private static final double kFrontLeftEncoderOffset = -0.82763671875;
    ...
    private static final double kFrontRightEncoderOffset = -0.323486328125;
    ...
    private static final double kBackLeftEncoderOffset = -0.5712890625;
